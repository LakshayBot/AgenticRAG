...
export default function DashboardPage() {
  ...
  return (
    // Main area: flex row matching HTML prototype
    <main className="flex-1 p-4 md:p-6 lg:p-8 flex flex-col xl:flex-row xl:items-stretch gap-6 lg:gap-8 overflow-x-hidden min-h-screen relative z-10 w-full">

      {/* LEFT COLUMN */}
      <div className="w-full xl:w-64 flex flex-col md:flex-row xl:flex-col gap-6 md:mt-16 relative z-10 shrink-0 xl:self-stretch">
        {loadingAdvisory ? (
      ...
      {/* CENTER COLUMN */}
      <div className="flex-1 flex flex-col xl:mt-16 gap-6 relative z-10 w-full min-w-0">
        {loadingAdvisory ? (
      ...
      {/* RIGHT COLUMN */}
      <div className="w-full xl:w-64 flex flex-col md:flex-row xl:flex-col gap-6 md:mt-16 relative z-10 shrink-0">
        {loadingAdvisory ? (
          <>
