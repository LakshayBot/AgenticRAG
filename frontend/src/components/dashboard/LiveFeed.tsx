    ...
    <>
      ...
      <div className="w-full">
        <a
          ...
          className="bg-surface-container-lowest hover:bg-surface-container-low text-on-surface p-4 rounded-xl flex items-center justify-center gap-3 transition-colors border border-outline-variant/10 shadow-sm group w-full"
        >
          <svg
            width="20"
            height="20"
            viewBox="0 0 98 96"
            className="text-on-surface group-hover:scale-110 transition-transform shrink-0"
          >
            <path
              fill="currentColor"
              fillRule="evenodd"
