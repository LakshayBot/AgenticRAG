...
from src.routers import advisories, agentic_ask, hybrid_search, ping, upload
...
app = FastAPI(
    ...
    description="Security advisory and document RAG system with GitHub Security Advisories and uploaded PDFs",
...
app.include_router(upload.router, prefix="/api/v1")  # PDF upload functionality
app.include_router(advisories.router)  # GitHub Security Advisories ingestion
