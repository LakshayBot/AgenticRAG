...
class SourceItem(BaseModel):
    ...
    :param source_id: Source identifier (GHSA ID for advisories, upload ID for PDFs)
    ...
    source_id: str = Field(description="Source identifier (GHSA ID or upload ID)")
    title: str = Field(description="Document title")
    authors: List[str] = Field(default_factory=list, description="List of authors")
    url: str = Field(description="Link to document")
