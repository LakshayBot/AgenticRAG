...
SECURITY_RAG_CHUNKS_INDEX = "security-rag-chunks"

# Index mapping for chunked documents with vector embeddings
SECURITY_RAG_CHUNKS_MAPPING = {
    "settings": {
        "number_of_shards": 1,
    ...
    "mappings": {
        ...
        "properties": {
            ...
            "source_type": {"type": "keyword"},  # "github_advisory" or "uploaded"
            # ===== Advisory-specific Fields =====
            "ghsa_id": {"type": "keyword"},  # Primary advisory identifier
            "advisory_id": {"type": "keyword"},  # Internal DB UUID
            "cve_id": {"type": "keyword"},
            ...
            "section_name": {"type": "keyword"},  # Advisory chunk section label
            # ===== Upload-specific Fields =====
            "source_id": {"type": "keyword"},  # Generic source ID for uploaded PDFs
            "upload_id": {"type": "keyword"},  # For uploaded PDFs
            # ===== Common Chunk Fields =====
